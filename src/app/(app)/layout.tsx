...
const SECTIONS: { title: string; hrefs: string[] }[] = [
  ...
  { title: "الحسابات", hrefs: ["/cash", "/loans", "/expenses", "/income", "/finance", "/profit", "/reports", "/analytics"] },
...
export default async function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  const sidebar = (
    <aside className="h-full bg-navy text-neutral-300 flex flex-col shadow-[0_0_40px_rgba(0,0,0,0.35)] md:h-screen md:sticky md:top-0 md:border-l md:border-white/10">
